...
function activateLeftNode() {
  ctx.activateLeftNode();
}

function activateUpNode() {
  ctx.activateUpNode();
}

function activateDownNode() {
  ctx.activateDownNode();
}

function activateRightNode() {
  ctx.activateRightNode();
}
